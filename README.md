# ignite_template_componentizando_a_aplicacao
A aplicação tem como objetivo principal a refatoração da página para listagem de filmes de acordo com gênero. 
